$(document).ready(function () {
  ...
  console.log("Label for the search input using an attribute selector", $("label[for='q']"));

  console.log("\n");

  console.log("Hidden elements in the page", $("body").find(":hidden").not("script").length);

  console.log("\n");

  console.log("Image element that have alt attribute", $("img[alt]").length);
